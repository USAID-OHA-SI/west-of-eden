...
### SUMMARY OF TARGETS FOR CARIBBEAN BY COUNTRY  
...
t1 %>% gtsave(path = "Images", filename = "Caribbean_Target_Diffs_AllPop_Countries_041423.pdf",
              expand=20)
t2 %>% gtsave(path = "Images", filename = "Caribbean_Target_Diffs_KP_Countries_041423.pdf",
              expand=20)
